...
const page = () => {
  return (
    <div>
      <Navbar></Navbar>
      <div style={{maxWidth: 800, minWidth: 300, margin: "0 auto", padding: 50}}>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to MM Rent a car MMC, Ataturk Prospekti
              4B.
            </p>
          </li>
          <li>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Rent a car in Baku, accessible
              from{" "}
              <a
                href="https://www.rentacarsinbaku.com/"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://www.rentacarsinbaku.com/
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>
            <p>By email: rentacarsinbaku@gmail.com</p>
          </li>
          <li>
            <p>By phone number: +994105407474</p>
          </li>
        </ul>
      </div>
